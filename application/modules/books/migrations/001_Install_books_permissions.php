...
class Migration_Install_books_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Books.Content.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Books.Content.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Books.Content.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Books.Content.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
