...
class Migration_Install_site_settings_permissions extends Migration {

	// permissions to migrate
	private $permission_values = array(
        array('name' => 'Site_settings.Settings.View', 'description' => '', 'status' => 'active',),
		array('name' => 'Site_settings.Settings.Create', 'description' => '', 'status' => 'active',),
        array('name' => 'Site_settings.Settings.Edit', 'description' => '', 'status' => 'active',),
        array('name' => 'Site_settings.Settings.Delete', 'description' => '', 'status' => 'active',)
	);
